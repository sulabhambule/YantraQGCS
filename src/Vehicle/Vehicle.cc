      ...
      _vehicleFactGroup(this)
{
    ...
    // Hardcode some fake values so they show up on the screen even when disconnected!
    // _altitudeRelativeFact.setRawValue(10.0);
    // _altitudeAMSLFact.setRawValue(15.0);
    // _distanceToHomeFact.setRawValue(5.0);
}
